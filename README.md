...
`Its only a PoC`, not a working cheat, just the concept that it can be accomplished and i believe if someone pays attention and their own time in this, can made a working undetected aimbot.
